...
<!--                      <img src="images/articles/article-pic-11.png" alt="">-->
          ...
          <!-- END FEATURED -->
          <!-- BEGIN TABLE -->
          <div class="col-12 category-calendar__table--wrap">
            <div class="category-calendar__table">
	            <?php for ($i = 0; $i < 15; $i++): ?>
              <div class="category-calendar__table--row">
                <div class="category-calendar__table--col">
                  <span class="category-calendar__table--date">08/29</span>
                  <span class="category-calendar__table--day">Tis</span>
                  <div class="category-calendar__table--star">
                    <i class="icon-star"></i>
                    <span>4.8</span>
                  </div>
                </div>
                <div class="category-calendar__table--col f-grow">
                  <h4 class="category-calendar__table--title">Hickleport</h4>
                  <div class="category-calendar__table--subtitle">
                    <span>7 avgångar</span>
                    <span>5 dagar</span>
                  </div>
                </div>
                <div class="category-calendar__table--col align-items-center">
                  <div class="category-calendar__table--price">Från 14 493 :-</div>
                  <button class="category-calendar__table--btn btn btn-blue">boka</button>
                </div>
              </div>
	            <?php endfor; ?>
            </div>
